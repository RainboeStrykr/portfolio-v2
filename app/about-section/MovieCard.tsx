...
import { MovieProps } from "./movieDetails";
import Link from "next/link";

const MovieCard = ({ title, director, image, link }: MovieProps) => {
  return (
    <Link href={link} target="_blank" aria-label="Check out movie on IMDb">
      <div
      ...
      >
        ...
        <div className="absolute bottom-3 left-5 hidden">
          <p className="text-[14px] text-white">{director}</p>
