...
function GalleryScene({
	...
	const handleWheel = useCallback(
		(event: WheelEvent) => {
			...
			setScrollVelocity((prev) => prev + event.deltaY * 0.015 * speed);
			setAutoPlay(false);
...
function FallbackGallery({ images }: { images: ImageItem[] }) {
	...
	return (
		<div className="flex h-full flex-col items-center justify-center bg-[#0E1016] p-4">
			<p className="mb-4 text-[#e4ded7]/70">
